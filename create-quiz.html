    ...
    <!-- Create Course Step List End -->
            ...
            <div class="card">
                <div class="card-header border-bottom border-gray-100 flex-between flex-wrap gap-8">
                    ...
                    <button type="button" class="border border-gray-100 rounded-pill py-8 px-20" data-bs-toggle="modal" data-bs-target="#exampleModalOne">
                        Add Question
                    </button>
                ...
                <div class="card-body">
                        ...
                        <div class="mb-20">
                            ...
                            <div class="row g-20">
                                <div class="col-sm-6">
                                    <div class="delete-item py-15 px-16 rounded-8 bg-gray-50 border border-main-200 flex-align gap-8">
                                        ...
                                        <span class="text-gray-500">Web layout idesign</span>
                                ...
                                <div class="col-sm-6">
                                    <div class="delete-item py-15 px-16 rounded-8 bg-gray-50 border border-main-200 flex-align gap-8">
                                        ...
                                        <span class="text-gray-500">Content Strategy</span>
                                        <button type="button" class="delete-btn text-danger-600 text-xl ms-auto d-flex"><i class="ph-fill ph-x-circle"></i></button>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="delete-item py-15 px-16 rounded-8 bg-gray-50 border border-main-200 flex-align gap-8">
                                        ...
                                        <span class="text-gray-500">User Friendly</span>
                                        <button type="button" class="delete-btn text-danger-600 text-xl ms-auto d-flex"><i class="ph-fill ph-x-circle"></i></button>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="delete-item py-15 px-16 rounded-8 bg-gray-50 border border-main-200 flex-align gap-8">
                                        ...
                                        <span class="text-gray-500">Design Idea</span>
                                        <button type="button" class="delete-btn text-danger-600 text-xl ms-auto d-flex"><i class="ph-fill ph-x-circle"></i></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Add Choices</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <input type="text" class="form-control" placeholder="Add Quiz Choices">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary py-9" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-main py-9">Save</button>
                    ...
                    <div class="flex-align justify-content-end gap-8">
                        <a href="about-course.html" class="btn btn-outline-main rounded-pill py-9">Back</a>
                        <a href="publish-course.html" class="btn btn-main rounded-pill py-9">Continue</a>
                    </div>
                </div>
            </div>
            <!-- Course Tab End -->
    ...
    <script src="assets/js/main.js"></script>
        ...
        <script>    
            $('.delete-btn').on('click', function () {
                $(this).closest('.delete-item').parent().addClass('d-none')
            }); 
    </script>
    </body>
</html>
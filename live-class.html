            ...
            <div class="row gy-4">
                <div class="col-md-8">
                    <div class="rounded-16 overflow-hidden position-relative">
                        ...
                        <video id="player" class="player" playsinline controls data-poster="assets/images/thumbs/live-class.png">
                    ...
                    <div class="card mt-24">
                        <div class="card-body">
                            <div class="pb-24 flex-between gap-4 flex-wrap">
                                ...
                                <a href="#" class="btn btn-outline-gray text-gray-500 text-13 py-8 px-8 rounded-4">See All</a>
                            </div>
                            ...
                            <ul class="comment-list">
                                <li>
                                    ...
                                    <ul class="sub-comment-list mt-24">
                                        <li>
                                            <div class="d-flex align-items-start gap-8 flex-xs-row flex-column">
                                                <img src="assets/images/thumbs/mentor-img2.png" alt="" class="w-48 h-48 rounded-circle object-fit-cover flex-shrink-0">
                                                <div class="">
                                                    <div class="flex-align flex-wrap gap-8">

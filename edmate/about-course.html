...
<div class="breadcrumb mb-24">
    <ul class="flex-align gap-4">
        ...
        <li><span class="text-main-600 fw-normal text-15">About Course</span></li>
    </ul>
</div>
<!-- Breadcrumb End -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="upload-card-item p-16 rounded-12 bg-main-50 mb-20"> 
                        <div class="flex-between gap-8">
                            <div class="flex-align gap-10 flex-wrap">
                                ...
                                <div class="">
                                    <p class="text-15 text-gray-500">Drag & drop your single/multiple videos of course, or Browse </p>
                    ...
                    <div class="flex-align justify-content-end gap-8 mt-20">
                        <a href="upload-videos.html" class="btn btn-outline-main rounded-pill py-9">Back</a>
                        <a href="create-quiz.html" class="btn btn-main rounded-pill py-9">Continue</a>
                    </div>
                </div>
            </div>
            <!-- Course Tab End -->

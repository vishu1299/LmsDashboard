...
<div class="breadcrumb mb-24">
    <ul class="flex-align gap-4">
        ...
        <li><span class="text-main-600 fw-normal text-15">Starred Email</span></li>
    </ul>
</div>
<!-- Breadcrumb End -->
            ...
            <div class="row gy-4">
                <div class="col-xl-3">
                    <div class="card h-100 p-0">
                        <div class="card-body p-24">
                            <button type="button" class="btn btn-main text-sm px-12 py-12 w-100 rounded-pill flex-center gap-8 mb-16">
                            ...
                            <div class="mt-16">
                                <ul>
                                    <li class="mb-8 email-links">
                                        <a href="email.html" class="hover-bg-main-50 px-20 py-8 w-100 rounded-pill text-gray-300 hover-text-gray-600">
                                            <span class="flex-between gap-10 w-100">
                                                <span class="flex-center gap-10">   
                                                    <span class="icon text-xl line-height-1 d-flex">
                                                        <i class="ph ph-envelope-simple"></i>
                                                    </span>
                                                    <span class="fw-medium">Inbox</span>
                                                </span>
                                                <span class="fw-medium">425</span>
                                            </span>
                                        </a>
                                    </li>
                                    <li class="mb-8 email-links">
                                        <a href="starred.html" class="hover-bg-main-50 px-20 py-8 w-100 rounded-pill text-gray-300 hover-text-gray-600">
                                            <span class="flex-between gap-10 w-100">
                                                <span class="flex-center gap-10">   
                                                    <span class="icon text-xl line-height-1 d-flex">
                                    ...
                                    <li class="mb-8 email-links">
                                        <a href="#" class="hover-bg-main-50 px-20 py-8 w-100 rounded-pill text-gray-300 hover-text-gray-600">
                                            <span class="flex-between gap-10 w-100">
                                                <span class="flex-center gap-10">   
                                                    <span class="icon text-xl line-height-1 d-flex">
                ...
                <div class="col-xl-9">
                    <div class="card h-100 p-0 email-card">
                        <div class="card-header border-bottom bg-base py-16 px-24">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-4">
                                <div class="flex-center gap-16">
                                    <div class="form-check style-check flex-center mb-0 gap-8">
                                        <input class="form-check-input radius-4 border border-gray-200" type="checkbox" name="checkbox" id="selectAll">
                                        <div class="dropdown line-height-1">
                                            ...
                                            <ul class="dropdown-menu p-12 border bg-base shadow">
                                                <li>
                                                    <button type="button" class="dropdown-item px-16 py-4 rounded-8 text-gray-400 bg-hover-neutral-200 text-hover-neutral-900">
                                                        All
                                                    </button>
                                                </li>
                                                <li>
                                    ...
                                    <button type="button" class="delete-button d-none text-secondary-light text-xl d-flex  rounded-4">
                                        <i class="ph ph-trash"></i>
                                    </button>
                                    <button type="button" class="reload-button text-secondary-light text-xl d-flex rounded-4">
                                        <i class="ph ph-arrows-clockwise"></i>
                                    </button>
                                    <div class="dropdown">
                                        <button type="button" data-bs-toggle="dropdown" aria-expanded="false" class=" d-flex rounded-4"> 
                                            <i class="ph-fill ph-dots-three-outline-vertical"></i>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu--lg p-12 border bg-base shadow">
                                            <li>
                                                <button type="button" class="dropdown-item px-16 py-8 rounded-8 text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 flex-center justify-content-start gap-10">
                                                    <i class="ph ph-envelope-simple"></i>
                                                    Mark all as read
                                                </button>
                                            </li>
                                ...
                                <div class="flex-center gap-16">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link d-flex border text-gray-500 hover-bg-gray-50 text-xl w-40 h-32 flex-center" href="javascript:void(0)"><i class="ph ph-caret-left"></i> </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link d-flex border text-gray-500 hover-bg-gray-50 text-xl w-40 h-32 flex-center" href="javascript:void(0)"><i class="ph ph-caret-right"></i> </a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <ul class="overflow-x-auto scroll-sm scroll-sm-horizontal">
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    <div class="form-check style-check flex-center mb-0 gap-8">
                                        <input class="form-check-input radius-4 border border-gray-200" type="checkbox" name="checkbox">
                                    </div>
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Jerome Bell</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    <div class="form-check style-check flex-center mb-0 gap-8">
                                        <input class="form-check-input radius-4 border border-gray-200" type="checkbox" name="checkbox">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Kristin Watson</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Cody Fisher</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Dianne Russell</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Floyd Miles</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Devon Lane</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                ...
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Annette Black</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Bessie Cooper</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Courtney Henry</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                                <li class="email-item px-24 py-16 flex-align gap-16 border-bottom border-gray-100 cursor-pointer min-w-max-content">
                                    ...
                                    <a href="veiw-details.html" class="text-heading fw-medium text-md text-line-1 w-190">Wade Warren</a>
                                    <a href="veiw-details.html" class="text-heading fw-medium mb-0 text-line-1 max-w-740">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                                    <span class="text-heading fw-medium min-w-max-content ms-auto">6:07 AM</span>
                                </li>
                            </ul>
...
<script>
    ...
    $('.starred-button').on('click', function () {
        ...
        if(icon.hasClass('ph ph-star')) {
            icon.removeClass('ph ph-star'); 
            icon.addClass('ph-fill ph-star text-warning-600'); 
        } else {
            icon.removeClass('ph-fill ph-star text-warning-600'); 
            icon.addClass('ph ph-star'); 
        }
    }); 
</script>

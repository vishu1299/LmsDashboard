...
<!-- Breadcrumb End -->
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-9">
                    <div class="card">
                        <div class="card-header py-16 border-bottom border-gray-100 flex-between gap-16">
                            <div class="d-flex align-items-center gap-8">
                                <a href="email.html" class="text-gray-600 hover-text-main-600 d-flex me-8 text-2xl">
                                    <i class="ph ph-arrow-left"></i>
                                </a>
                                <h6 class="mb-0 text-lg">Kate Morrison</h6>
                                <span class="bg-primary-50 text-primary-600 text-sm rounded-4 px-8">Personal</span>
                            </div>
                            <div class="d-flex align-items-center gap-16">
                                <button class="text-gray-400 text-xl d-flex starred-button">
                                    <i class="ph ph-star"></i>
                                </button>
                                <button class="text-gray-400 text-xl d-flex">
                        ...
                        <div class="card-body p-0">
                            <div class="chat-box-item-wrapper style-email overflow-y-auto scroll-sm">
                                <div class="p-24 border-bottom">
                                    <div class="d-flex align-items-start gap-16">
                                        <img src="assets/images/thumbs/avatar-img2.png" alt="" class="w-40-px h-40-px rounded-pill">
                                        <div class="">
                                            <div class="d-flex align-items-center flex-wrap gap-8">
                                                <h6 class="mb-0 text-lg">Kate Morrison</h6>
                                                <span class="text-gray-300 text-sm">kathrynmurphy@gmail.com</span>
                                            </div>
                                            <div class="mt-20">
                                                <p class="mb-16 text-primary-light">Hi Kate</p>
                                ...
                                <div class="p-24 border-bottom">
                                    <div class="d-flex align-items-start gap-16">
                                        <img src="assets/images/thumbs/avatar-img1.png" alt="" class="w-40-px h-40-px rounded-pill">
                                        <div class="">
                                            <div class="d-flex align-items-center flex-wrap gap-8">
                                                <h6 class="mb-0 text-lg">John Doe</h6>
                                                <span class="text-gray-300 text-sm">johndoe@gmail.com</span>
                                            </div>
                                            <div class="mt-20">

            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="upload-card-item p-16 rounded-12 bg-main-50 mb-20"> 
                        <div class="flex-align gap-10 flex-wrap">
                            ...
                            <div class="">
                                ...
                                <p class="text-13 text-gray-600">Mp4 format with 16:9 aspect ration (max file size 100mb each)</p>
                    ...
                    <div class="upload-card-item p-16 rounded-12 bg-main-50 mb-20"> 
                        <div class="flex-between flex-wrap gap-4">
                            <div class="flex-align gap-10">
                                <img src="assets/images/thumbs/upload-video-img1.png" alt="w-88 h-56 rounded-8" class="">
                                <div class="">
                                    <p class="text-15 text-gray-500">Complete Web & Mobile Designer: UI/UX, Figma.mp4</p>
                                    <p class="text-13 text-gray-600">1:40 min 20 sec</p>
                                </div>
                            </div>
                        ...
                        <p class="mt-20 pt-20 border-top border-main-200">Build beautifully designed web and mobile projects for your customers using modern tools used by top companies in 2024. Includes 100+ assets and premium design templates that you can keep and use to customize for all your future projects. Learn to design for all types of devices using Figma and other tools used by some of the top designers in the world. Get hired as a Designer or become a freelancer that can work from anywhere and for anyone. Designers are in high demand!</p>
                    </div>
                    ...
                    <div class="upload-card-item p-16 rounded-12 bg-main-50 mb-20"> 
                        <div class="flex-between flex-wrap gap-4">
                            <div class="flex-align gap-10">
                                <img src="assets/images/thumbs/upload-video-img2.png" alt="w-88 h-56 rounded-8" class="">
                                <div class="">
                                    <p class="text-15 text-gray-500">Complete Web & Mobile Designer: UI/UX, Figma.mp4</p>
                                    <p class="text-13 text-gray-600">1:40 min 20 sec</p>
                                </div>
                    ...
                    <!-- Upload Card item Start -->
                    <div class="upload-card-item p-16 rounded-12 bg-main-50"> 
                        <div class="flex-between flex-wrap gap-4">
                            <div class="flex-align gap-10">
                                <img src="assets/images/thumbs/upload-video-img3.png" alt="w-88 h-56 rounded-8" class="">
                                <div class="">
                                    <p class="text-15 text-gray-500">Complete Web & Mobile Designer: UI/UX, Figma.mp4</p>
                                    <p class="text-13 text-gray-600">1:40 min 20 sec</p>
                                </div>
                    ...
                    <div class="flex-align justify-content-end gap-8 mt-20">
                        <a href="create-course.html" class="btn btn-outline-main rounded-pill py-9">Back</a>
                        <a href="about-course.html" class="btn btn-main rounded-pill py-9">Continue</a>
                    </div>
                </div>
            </div>
            <!-- Course Tab End -->
